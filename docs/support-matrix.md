...
| Claude.ai | `claude.ai/new#settings/usage` | Usage-credit balance; current session; weekly all-models; weekly Fable; monthly usage-credit cap | Claude Pro usage screen. Fable is shown while the provider exposes it; Max and future plan layouts are unverified. |
